...
\begin{document}
 ...
 \subsection*{nightly}
 These changes have not yet been given an official version number.
 \begin{itemize}
  \item Detect duplicate surface names. Should prevent exports with broken hierarchy, i.e. ModView error "Model has X surfaces, but only Y of them are connected up through the hierarchy, the rest will never be recursed into."
 \end{itemize}
