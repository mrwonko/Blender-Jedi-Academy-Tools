...
Cagelight has taken it upon himself to improve upon the plugin suite I built around this plugin and started a fork. [Check it out!](https://github.com/cagelight/jedi-academy-blender-suite) With it, you no longer need to manually split UV Seams.
